...
struct informationString OPCN3NanoMints::readInformationString() {
printMintsBegin();
...
struct serialNumber OPCN3NanoMints::readSerialNumber() {
printMintsBegin();
...
struct pmData OPCN3NanoMints::readPMData() {
  printMintsBegin();
  Serial.println("Reading Histogram Data ");
  int  size = 14;
  byte inputByte =  0X32;
